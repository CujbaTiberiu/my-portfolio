        ...
        <div className="text-white h-full">
          <div className="w-full grid lg:grid-cols-2">
            <div className="flex justify-center">
              <div>
                <p className="mx-4 text-sky-800">Hi, my name is</p>
          ...
          <div className="py-4 w-full grid lg:grid-cols-2">
            <div className="flex justify-center">
              <div>
                <div className="mx-4">
                  <p className="my-4 font-bold text-3xl border-b-4 w-40 border-sky-800  hover:text-4xl hover:w-60 duration-500 ">
                    Backround
                  </p>
                </div>
