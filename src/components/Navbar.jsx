    ...
    <div className="fixed top-0 w-full flex justify-between items-center h-20 text-white px-4 shadow-md shadow-sky-800 bg-black z-10">
      ...
      <ul className="flex hidden lg:flex">
        <Link to="hero" smooth={true} duration={500}>
          <li className="p-4 flex hover:border-b border-b-sky-800 hover:text-sky-800 duration-100 cursor-pointer">
            {" "}
        ...
        <Link to="certificate" smooth={true} duration={500}>
          <li className="p-4 flex hover:border-b border-b-fuchsia-800 hover:text-fuchsia-800 duration-100 cursor-pointer">
            {" "}
            <RiPagesLine className="mt-1 mx-1" /> Certificate
          </li>
        </Link>
        <Link to="form" smooth={true} duration={500}>
          <li className="p-4 flex hover:border-b border-b-yellow-500 hover:text-yellow-500 duration-100 cursor-pointer">
            {" "}
      ...
      <div
        className={
          !nav
            ? "fixed right-[-100%]"
            : "fixed right-0 top-0 w-[40%] xs:w-[70%] sm:w-[35%] md:w-[25%] h-[100%] bg-black border-l border-l-sky-800 mt-[82px] ease-in-out duration-500 first-letter:"
        }
      >
        <ul className="mt-4 uppercase">
          <Link to="hero" smooth={true} duration={500}>
            <li
              onClick={handleNav}
              className="p-4 border-b border-b-sky-800 w-36 m-2 flex hover:w-44 duration-200  hover:text-sky-800 cursor-pointer"
            >
              <RiUserVoiceFill className="mt-1 mx-1" /> About me
            </li>
          </Link>
          ...
          <Link to="certificate" smooth={true} duration={500}>
            <li
              onClick={handleNav}
              className="p-4 border-b border-b-sky-800 w-40 m-2 flex hover:w-44 duration-200  hover:text-fuchsia-800 cursor-pointer"
            >
              <RiPagesLine className="mt-1 mx-1" /> Certificate
            </li>
          </Link>
          <Link to="form" smooth={true} duration={500}>
            <li
              onClick={handleNav}
              className="p-4 border-b border-b-sky-800 w-36 m-2 flex hover:w-44 duration-200  hover:text-yellow-500 cursor-pointer"
            >
              <TiContacts className="mt-1 mx-1" /> Contact
            </li>
          </Link>
          <a href="https://github.com/CujbaTiberiu">
            <li
              onClick={handleNav}
              className="p-4 border-b border-b-sky-800 w-36 m-2 flex hover:w-44 duration-200 hover:text-gray-700"
            >
              <AiFillGithub className="mt-1 mx-1" /> GitHub
            </li>
          </a>
          <a href="https://www.linkedin.com/in/tiberiu-stefan-cujba/">
            <li
              onClick={handleNav}
              className="p-4 border-b border-b-sky-800 w-36 m-2 flex hover:w-44 duration-200 hover:text-sky-600"
            >
              <AiFillLinkedin className="mt-1 mx-1" /> Linkedin
            </li>
          </a>
